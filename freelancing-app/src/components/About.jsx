          ...
          <div className="container">
            ...
            <div className="row align-items-center mb-5">
              <div className="col-lg-6">
                ...
                <p className="lead">
                  Our platform connects freelancers with businesses worldwide.
                  We provide a seamless way for skilled professionals to find
                  work and for businesses to hire top talent.
                </p>
                <p>
                  Whether you're a developer, designer, writer, or marketer, our
                  platform offers the perfect opportunity to showcase your
            ...
            <div className="row bg-white p-4 shadow rounded">
              ...
              <div className="col-md-6">
                <blockquote className="blockquote">
                  <p className="mb-3">
                    "Hiring on this platform was quick and easy. Found an
